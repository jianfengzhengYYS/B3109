...
static const unsigned long br3109_available_scan_masks[] = {
...
static const struct axiadc_chip_info axiadc_chip_info_tbl[] = {
	[ID_BR3109] = {
		...
		.max_testmode = 0,
		.num_channels = 4,
		.scan_masks = br3109_available_scan_masks,
...
static int br3109_read_raw(struct iio_dev *indio_dev,
...
static int br3109_write_raw(struct iio_dev *indio_dev,
			      struct iio_chan_spec const *chan,
			      int val,
			      int val2,
			      long mask)
...
EXPORT_SYMBOL(br3109_hdl_loopback);

static int br3109_post_setup(struct iio_dev *indio_dev)
{
...
int br3109_register_axi_converter(struct br3109_rf_phy *phy)
{
	...
	if (phy->spi_device_id == ID_BR31082)
		return 0;
	...
	conv->write_raw = br3109_write_raw;
	conv->read_raw = br3109_read_raw;
	conv->post_setup = br3109_post_setup;
	conv->spi = spi;
	conv->phy = phy;
...
EXPORT_SYMBOL(br3109_register_axi_converter);
...
EXPORT_SYMBOL(br3109_spi_to_phy);
