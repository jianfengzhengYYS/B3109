...
#include "br3109_talise/br3109_gpio_types.h"
#include "br3109_talise/linux_hal.h"

#include "br3109_talise/br3109.h"
#include "br3109_talise/br3109_jesd204.h"
#include "br3109_talise/br3109_arm.h"
#include "br3109_talise/br3109_radioctrl.h"
#include "br3109_talise/br3109_cals.h"	
#include "br3109_talise/br3109_error.h"
#include "br3109_talise/br3109_agc.h"	
#include "br3109_talise/br3109_tx.h"
#include "br3109_talise/br3109_rx.h"
#include "br3109_talise/br3109_gpio.h"
#include "br3109_talise/br3109_user.h"
#include "br3109_talise/br_hal.h"
#include "br3109_talise/br3109_config.h"
...
struct gain_table_info {
	...
	u8 dest;
	s32 *abs_gain_tbl;
	br3109RxGainTable_t *gainTablePtr;
	br3109OrxGainTable_t *orx_gainTablePtr;
};
...
struct br3109_rf_phy {
	...
	br3109Device_t 		talise_device;
	br3109Device_t 		*talDevice;
	br3109Init_t 		talInit;
	br3109AuxDac_t		auxdac;
	br3109AgcCfg_t 		rxAgcCtrl;
	br3109ArmGpioConfig_t	arm_gpio_config;
	br3109OrxLoCfg_t 	orx_lo_cfg; /* Fixme: BR3109_setOrxLoCfg */
	br3109FhmConfig_t	fhm_config;
	br3109FhmMode_t		fhm_mode;
	br3109RxGainCtrlPin_t	rx1_gain_ctrl_pin;
	br3109RxGainCtrlPin_t	rx2_gain_ctrl_pin;
	br3109TxAttenCtrlPin_t	tx1_atten_ctrl_pin;
	br3109TxAttenCtrlPin_t	tx2_atten_ctrl_pin;
	br3109TxPaProtectCfg_t	tx_pa_protection;
	br3109RxHd2Config_t	rx_hd2_config;
