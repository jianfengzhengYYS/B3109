/**
 * \file br3109_tx_types.h
 * \brief Contains Br3109 API Tx datapath data types
 *
...
#ifndef BR3109_TX_TYPES_H_
#define BR3109_TX_TYPES_H_
...
typedef enum
{
    ...
    TAL_TX1	  =0x01,            /*!< Tx1 channel enabled */
    TAL_TX2	  =0x02,            /*!< Tx2 channel enabled */
    TAL_TX1TX2=0x03,          /*!< Tx1 + Tx2 channels enabled */
} br3109TxChannels_t;
...
} br3109TxAttenStepSize_t;

/**
 *  \brief Data structure to hold Br3109 Tx NCO test tone Configuration
 */
typedef struct
{
...
/**
 *  \brief Data structure to hold Br3109 Tx NCO Configuration (tone configuration, enable/disable and tone phase configuration)
 */
typedef struct
{
    br3109TxNCOSelect_t enableNCO; /* < 0 = Disable NCO, 1 = Enable Tx1 NCO, 2 = Enable Tx2 NCO, */
...
} br3109TxNcoShifterCfg_t;


/**
 *  \brief Data structure to hold Br3109 Tx Attenuation Control Pin Configuration
 */
typedef struct
{
        ...
        br3109GpioPinSel_t txAttenIncPin;   /*!< GPIO used to increment Tx attenuation
                                                 Tx1 : TAL_GPIO_04 or TAL_GPIO_12
                                                 Tx2 : TAL_GPIO_06 or TAL_GPIO_14 */
        br3109GpioPinSel_t txAttenDecPin;    /*!< GPIO used to decrement Tx attenuation
...
} br3109TxAttenCtrlPin_t;

/**
 *  \brief Data structure to hold Br3109 Tx PA Protection configuration settings
 */
typedef struct
{
...
} br3109TxPaProtectCfg_t;

#ifdef __cplusplus
}
#endif

#endif /* BR3109_TX_TYPES_H_ */
