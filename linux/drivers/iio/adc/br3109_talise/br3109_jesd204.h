/**
 * \file br3109_jesd204.h
 * \brief Contains Br3109 JESD204b data path related function prototypes for
 *        br3109_jesd204.c
 *
...
#ifndef BR3109_JESD204_H_
#define BR3109_JESD204_H_
 ...
 */
  ...
  *
  * This function is called automatically by BR3109_initialize() if the Tx profile is valid.
  ...
  *
  * \param device Structure pointer to the device settings structure
  * \param init Pointer to init settings for this Br3109 instance
  ...
  * \retval TALACT_NO_ACTION Function completed successfully, no action required
  */
 uint32_t BR3109_setupJesd204bFramer(br3109Device_t *device, br3109Init_t *init, br3109FramerSel_t framerSel);
 ...
 * serializer data before enabling the link so the Br3109 CDR (recovered clock) is locked.
 *
 * \pre This function may be called any time after device initialization.
 *
 * \dep_begin
 ...
 * \dep_end
 *
 * \param device Pointer to the Br3109d device settings data structure
 ...
 *
 * By default Br3109 has the SYSREF signal ungated, however, the Br3109 Multichip Sync state machine
...
/**
 * \brief Reads the Br3109 framer status for the framer selected by the framerSel input parameter
 *
 ...
 *
 * \param device is a pointer to the device settings structure
 * \param channelSel is a br3109TxChannels_t enumerated data type for DAC crossbar channel selection, where only TX1 or TX2 are valid choices
 * \param dacXbar is br3109DacSampleXbar_t enumerated data type used to map any deframer output to a specific DAC channel I or Q converter input for Tx
 *
 ...
 * \retval TALACT_NO_ACTION Function completed successfully, no action required
 */
uint32_t BR3109_setupDacSampleXbar(br3109Device_t *device, br3109TxChannels_t channelSel, br3109DacSampleXbar_t dacXbar);
 ...
 * The settings use the br3109AdcSampleXbarSelect_t enumerated type
 *
 ...
 */
uint32_t BR3109_setupAdcSampleXbar(br3109Device_t *device, br3109FramerSel_t framerSel, br3109AdcSampleXbar_t adcXbar);
/****************************************************************************
 * Debug functions
 ****************************************************************************
 */
 ...
 *
 * \param device is a pointer to the device settings structure
 * \param polyOrder selects the PRBS type based on enum values (TAL_PRBS_DISABLE, TAL_PRBS7, TAL_PRBS9, TAL_PRBS11, TAL_PRBS15, TAL_PRBS20, TAL_PRBS23, TAL_PRBS31)
 ...
 * \retval TALACT_NO_ACTION function completed successfully, no action required
 */
uint32_t BR3109_enableDeframerPrbsChecker(br3109Device_t *device, br3109DeframerPrbsOrder_t polyOrder, br3109DefPrbsCheckLoc_t checkerLocation);
 ...
 * \retval TALACT_NO_ACTION function completed successfully, no action required
 */
uint32_t BR3109_readDeframerPrbsCounters(br3109Device_t *device, uint8_t lane, uint64_t *prbsErrorCount, uint64_t *prbsCheckCount);

/**
 * \brief Compares received Lane0 ILAS configuration to Br3109 deframer
 ...
 *        structure of type br3109Jesd204bLane0Config_t to the dfrmCfg and
 ...
 *
 * \param dfrmCfg Pointer to a br3109Jesd204bLane0Config_t structure that
 *                returns the deframer configuration settings.  If NULL, data
 *                is not returned to the pointer.
 *
 * \param dfrmIlas Pointer to a br3109Jesd204bLane0Config_t structure that
 ...
 * \retval TALACT_NO_ACTION function completed successfully, no action required
 */
uint32_t BR3109_getDfrmIlasMismatch(br3109Device_t *device, br3109DeframerSel_t deframerSelect, uint32_t *mismatch, br3109Jesd204bLane0Config_t *dfrmCfg, br3109Jesd204bLane0Config_t *dfrmIlas);
 ...
 * \retval TALACT_NO_ACTION function completed successfully, no action required
 */
uint32_t BR3109_getDfrmIrqMask(br3109Device_t *device, br3109DeframerSel_t deframerSelect, uint32_t *irqMask);
 ...
 * \retval TALACT_NO_ACTION function completed successfully, no action required
 */
uint32_t BR3109_setDfrmIrqMask(br3109Device_t *device, br3109DeframerSel_t deframerSelect, uint32_t irqMask);
 ...
 * \retval TALACT_NO_ACTION function completed successfully, no action required
 */
uint32_t BR3109_clearDfrmIrq(br3109Device_t *device, br3109DeframerSel_t deframerSelect);
 ...
 * \retval TALACT_NO_ACTION function completed successfully, no action required
 */
uint32_t BR3109_getDfrmIrqSource(br3109Device_t *device, br3109DeframerSel_t deframerSelect, uint32_t *irqSourceValue);
 ...
 * \retval TALACT_NO_ACTION function completed successfully, no action required
 */
talRecoveryActions_t talFindDfrmrLaneCntErr(br3109Device_t *device,  br3109DeframerSel_t deframer, int32_t *deframerInputsMask);
 ...
 * \retval TALACT_NO_ACTION function completed successfully, no action required
 */
talRecoveryActions_t talFindDfrmrLaneErr(br3109Device_t *device,  uint32_t dfrmErrAddress, uint8_t nibbleToUse, int32_t *deframerInputsMask);
 ...
 *  to toggle SYNCB internal to the Br3109 device framer, allowing valid high
 *  speed serial data to start outputting from the Br3109 device.
 *
 *  This function would be used during device initialization when the JESD204B
 *  links are being initialized, after enabling the Br3109 framer link, and
