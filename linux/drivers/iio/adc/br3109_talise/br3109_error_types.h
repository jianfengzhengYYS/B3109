/**
 * \file br3109_error_types.h
 * \brief Contains Br3109 data types for API Error messaging
 *
...
#ifndef BR3109_ERROR_TYPES_H_
#define BR3109_ERROR_TYPES_H_
 ...
 */
typedef enum {
	TAL_ERRSRC_API,     /*!<API Error Src: Error codes defined by br3109Err_t */
	TAL_ERRSRC_BRHAL,  /*!<ADI HAL Error Src: Error codes defined by adiHalErr_t*/
	TAL_ERRSRC_TALARMCMD,  /*!< BR3109 ARM returned error */
	TAL_ERRSRC_TAL_API_GPIO,     /*!< BR3109 GPIO returned error */
	TAL_ERRSRC_TALAPIARM,  /*!< BR3109 API returned ARM error */
	TAL_ERRSRC_INITCALS,   /*!< BR3109 INITCALS returned error */
	TAL_ERRSRC_TAL_API_C0_PCA, /*!< Reserved Error source */
	TAL_ERRSRC_TAL_API_C0_PHMFOVR /*!< Reserved Error source */
} br3109ErrSources_t;

/**
 * \brief Enum of unique error codes from the Br3109 API functions.
...
typedef enum {
	...
	TAL_ERR_PROGRAMFIR_COEFS_INVAL,
	...
	BR3109_ERR_TXFIR_INV_NUMTAPS_PARM,
	BR3109_ERR_TXFIR_INV_NUMROWS,
	BR3109_ERR_TXFIR_TAPSEXCEEDED,
	BR3109_ERR_RXFIR_INV_DDC,
	BR3109_ERR_RXFIR_INV_NUMTAPS_PARM,
	BR3109_ERR_RXFIR_INV_NUMROWS,
	BR3109_ERR_RXFIR_TAPSEXCEEDED,
	BR3109_ERR_ORXFIR_INV_DDC,
	BR3109_ERR_ORXFIR_INV_NUMTAPS_PARM,
	BR3109_ERR_ORXFIR_INV_NUMROWS,
	BR3109_ERR_ORXFIR_TAPSEXCEEDED,
	...
	TAL_ERR_VERIFYBIN_CHECKSUM_ERR,
	...
	TAL_ERR_SETDCOFFSET_INV_CHN,
	TAL_ERR_GETDCOFFSET_INV_CHN,
	TAL_ERR_GETDCOFFSET_NULL_PARAM,
	TAL_ERR_GETDCOFFSETEN_NULL_PARAM,
...
typedef enum {
	...
	TAL_ERRHDL_APIARM_ERR,   /*!< Br3109 API layer ARM error handler */
	TAL_ERRHDL_ARM_CMD_ERR, /*!< Br3109 sendArmCommand error handler */
	TAL_ERRHDL_ARM_INITCALS_ERR, /*!< Br3109 init calibration error handler */
	TAL_ERRHDL_API_GPIO,   /*!< Br3109 GPIO error handler */
	TAL_ERRHDL_API_C0_PCA,   /*!< reserved error handler */
	TAL_ERRHDL_API_C0_PHMFOVR  /*!< reserved error handler */
} br3109ErrHdls_t;

/**
 *  \brief Enumerated list of Br3109 Recovery Actions used as return values
 *         APIs.
 */
typedef enum {
