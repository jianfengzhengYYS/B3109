/**
 * \file br3109_user.c
 * \brief Contains Br3109 API default gain table values for Rx and ObsRx channels.  This file contains information which can be modified by the user.
 *
 * Br3109 API version: 3.6.0.5
 *
 ...
 */
br3109RxGainTable_t rxGainTable [64] =
{
...
*/
br3109OrxGainTable_t orxGainTable [64] =
{
