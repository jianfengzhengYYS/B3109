/**
 * \file br3109_cals_types.h
 * \brief Contains Br3109 API Calibration data types
 *
...
#ifndef BR3109_CALS_TYPES_H_
#define BR3109_CALS_TYPES_H_
...
} br3109TrackingCalibrations_t;

/**
 *  \brief Enum of possible wait events to use with BR3109_waitForEvent()
 */
typedef enum
{
